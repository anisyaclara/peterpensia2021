...
class AccountController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('account', $this->data)->with('account_jenis', $account_jenis)->with('account_type', $account_type);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('account')->with('success', 'Data berhasil ditambahkan.');
    }
