...
class AccountJenisController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('accountJenis', $this->data);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/account-jenis')->with('success', 'Data berhasil ditambahkan.');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('/account-jenis')->with('success','Data berhasil diperbarui.');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect('/account-jenis')->with('success','Data berhasil dihapus.');
    }
}
