...
class AccountTypeController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('accountType', $this->data)->with('account_jenis', $account_jenis);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/account-tipe')->with('success', 'Data berhasil ditambahkan.');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('/account-tipe')->with('success','Data berhasil diperbarui.');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect('/account-tipe')->with('success','Data berhasil dihapus.');
    }
}
