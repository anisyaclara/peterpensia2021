...
class JournalController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('journal', $this->data)->with('account', $account);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/journal')->with('success','Data berhasil ditambahkan.');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('/journal')->with('success','Data berhasil diperbarui.');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect('/journal')->with('success','Data berhasil dihapus.');
    }
    ...
    public function posting(Request $request, $id){
        ...
        return redirect('/journal')->with('success','Data berhasil diposting ke buku besar.');
    }
}
