...
<div class="row">
    ...
    <div class="col-md-6">
      ...
      <div class="box box-dark">
        ...
        <table>
        <form role="form" method="post" enctype="multipart/form-data" action="/simpan-costumer">
                    ...
                    <tbody>
                        ...
                        @foreach ($costumers as $key => $c)
                            <tr>
                                ...
                                <td>{{ $c->alamat }}</td>
                                <td>
                                        <a href="/costumer-delete{{$c->id}}" class="btn btn-secondary btn-sm">Delete</a>
                                </td>
                            </tr>
                            @endforeach
                    </tbody>
