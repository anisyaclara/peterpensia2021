...
<div class="row">
    ...
    <div class="col-md-6">
      ...
      <div class="box box-dark">
        ...
        <table>
        <form role="form" method="post" enctype="multipart/form-data" action="/menu-simpan">
                    ...
                    @foreach ($menus as $key => $m)
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="/menu-delete-{{ $m->id }}"><button class="btn btn-secondary btn-sm">Delete</button></a>
                            </td>    
                        </tr>
                    @endforeach
